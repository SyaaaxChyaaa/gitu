...
console.log(chalk.red(`\r[ ${moment().format('HH:mm:ss')} ] ${chalk.green(`User : ${username}`)} | ${chalk.blue(`Trophy : ${trophy}`)} | ${chalk.red(`Crown : ${crown}`)} | ${chalk.green(`Exp : ${exp}`)} | ${chalk.blue(`Country : ${country}`)} | ${chalk.bgGreen(`StarPass : ${tokenPass}`)}`))
      await delay(3000);
